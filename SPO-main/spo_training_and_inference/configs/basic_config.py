...
def basic_config():
    ...
    config.dataset_cfg = dict(
        type="PromptDataset",
        meta_json_path='assets/prompts/100_training_prompts.json',
    ...
    #### validation ####
    config.validation_prompts = ['studio portrait of young female, curly hair, neutral expression, soft studio lighting, high-detail skin']
